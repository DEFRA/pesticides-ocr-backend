...
// without either inheriting the other's shape. `limit: 0` is Mongo's "no cap",
// which the export relies on to get the full matching set. Collection access
// lives in the shared ocr-search helper; this layer supplies filter and sort.
